...
class ModelConfigerAPI(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get(self, request, *args, **kwargs):
        return super(ModelConfigerAPI, self).get(request, *args, **kwargs)

    @api_webhook_for_delete(WebhookAction.PROJECT_DELETED)
    def delete(self, request, *args, **kwargs):
        return super(ModelConfigerAPI, self).delete(request, *args, **kwargs)
    ...
    def patch(self, request, *args, **kwargs):
        ...
        return super(ModelConfigerAPI, self).patch(request, *args, **kwargs)
    ...
    def put(self, request, *args, **kwargs):
        return super(ModelConfigerAPI, self).put(request, *args, **kwargs)
