  ...
  return (
    <td {...restProps}>
      {editing ? (
        ...
        >
          <TextArea
            placeholder="请输入提示学习模板,例:[dlg]你的心情很[mask]"
            allowClear
          />
        </Form.Item>
      ) : (
...
const PromptLearnTemplate = ({ project, request, close }) => {
...
export default PromptLearnTemplate;
